...
class GaussianDiffusion(nn.Module):
    ...
    def set_new_noise_schedule(self, schedule_opt, device):
        ...
        # check beta schedule
        # np.sqrt(alphas_cumprod)[T - 1] should be 0
        # 1 - alphas_cumprod[T - 1] should be 1
        # T = schedule_opt['n_timestep']
        # print(np.sqrt(alphas_cumprod)[T - 1])
        # print(1 - alphas_cumprod[T - 1])
